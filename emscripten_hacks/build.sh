...
emcc -s ALLOW_MEMORY_GROWTH=1 -s ASSERTIONS=1 --post-js jsinit.js -s "EXTRA_EXPORTED_RUNTIME_METHODS=['FS']" -Oz jslib.c libgit2.a -Isrc -I../src -I../include -o libgit2.js
